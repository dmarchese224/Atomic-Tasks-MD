const CACHE_NAME = 'atomic-tasks-md-v2';
const ASSETS = ['./','./index.html','./style.css','./app.js','./manifest.json','./assets/favicon.ico','./assets/atomic-notes-md.svg','./assets/icon-180.png','./assets/icon-192.png','./assets/icon-512.png'];
